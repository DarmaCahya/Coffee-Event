!(function () {
  ...
  function i(n, t) {
    try {
      for (var r in t)
        Object.defineProperty(n.prototype, r, { value: t[r], enumerable: !1 });
    } catch (e) {
      n.prototype = t;
    }
  }
    ...
    return (
      (t.on = function (t, u) {
        ...
        return arguments.length < 2
          ...
          : (o &&
              ((o.on = null),
              (r = r.slice(0, (i = r.indexOf(o))).concat(r.slice(i + 1))),
              e.remove(t)),
            u && r.push(e.set(t, { on: u })),
            n);
      }),
      t
    );
  ...
  function S(n, t) {
    ...
    function a() {
      ...
      null == r
        ? this.removeAttributeNS(n.space, n.local)
        : this.setAttributeNS(n.space, n.local, r);
    }
    return (
      (n = oa.ns.qualify(n)),
      null == t
  ...
  function C(n) {
    ...
    return function (r, e) {
      ...
      e
        ? ((t.lastIndex = 0),
          t.test(u) || r.setAttribute('class', k(u + ' ' + n)))
        : r.setAttribute('class', k(u.replace(t, ' ')));
    };
  }
  function L(n, t, r) {
    function e() {
  ...
  function F(n, t, r) {
    ...
    function u() {
      ...
      e.call(this),
        this.addEventListener(n, (this[o] = u), (u.$ = r)),
        (u._ = t);
    }
    function i() {
      var t,
        r = new RegExp('^__on([^.]+)' + oa.requote(n) + '$');
      for (var e in this)
        if ((t = e.match(r))) {
          var u = this[e];
  ...
  function Z(n, t) {
    ...
    if (r.createSVGPoint) {
      ...
      return (
        (e.x = t.clientX),
        (e.y = t.clientY),
        (e = e.matrixTransform(n.getScreenCTM().inverse())),
        [e.x, e.y]
      );
    }
  ...
  function ct(n, t, r) {
    return (
      isNaN(n) && (n = 0),
      isNaN(t) && (t = 0),
      lt(r, Math.cos((n *= Ia)) * t, Math.sin(n) * t)
    );
  }
  function lt(n, t, r) {
    return new st(n, t, r);
  ...
  function ft(n, t, r) {
    ...
    return (
      ...
      (i = gt(i) * tc),
      yt(
        vt(3.2404542 * u - 1.5371385 * e - 0.4985314 * i),
        vt(-0.969266 * u + 1.8760108 * e + 0.041556 * i),
        vt(0.0556434 * u - 0.2040259 * e + 1.0572252 * i)
      )
    );
  }
  function ht(n, t, r) {
    return n > 0
      ? ot(Math.atan2(r, t) * Ya, Math.sqrt(t * t + r * r), n)
      : ot(0 / 0, 0 / 0, n);
  }
  function gt(n) {
  ...
  function wt(n, t, r) {
    ...
    var e = pt((0.4124564 * n + 0.3575761 * t + 0.1804375 * r) / Qa),
      u = pt((0.2126729 * n + 0.7151522 * t + 0.072175 * r) / nc),
      i = pt((0.0193339 * n + 0.119192 * t + 0.9503041 * r) / tc);
  ...
  function qt() {
    var n = Tt(),
      t = zt() - n;
    t > 24
      ? (isFinite(t) && (clearTimeout(cc), (cc = setTimeout(qt, t))), (ac = 0))
      : ((ac = 1), sc(qt));
  }
  function Tt() {
    var n = Date.now();
      ...
      function t(t) {
        for (var r, u, i, o = [], a = -1, c = 0; ++a < e; )
          37 === n.charCodeAt(a) &&
            ...
            null != (u = mc[(r = n.charAt(++a))]) && (r = n.charAt(++a)),
            (i = A[r]) && (r = i(t, null == u ? ('e' === r ? ' ' : '0') : u)),
            o.push(r),
            (c = a + 1));
  ...
  function Wt(n, t, r) {
    return /^[+-]\d{4}$/.test((t = t.substring(r, r + 5)))
      ? ((n.Z = +t), r + 5)
      : -1;
  }
  function Gt(n) {
  ...
  function br(n, t) {
    return (
      Ma(n[1] - t[1]) < Fa &&
      (Ma(Ma(n[1]) - Ua / 2) < Fa || wr(n[0], t[0]) < Fa)
    );
  }
  function wr(n, t) {
    var r = Ma(t - n);
    ...
    return function (i, o) {
      ...
      function g() {
        ...
        if ((d.pop(), v.push(d), (d = null), e)) {
          ...
          e > 1 && 2 & t && r.push(r.pop().concat(r.shift())),
            p.push(r.filter(Rr));
        }
      }
      var p,
        ...
        x = {
          ...
          polygonEnd: function () {
            ...
            p.length
              ? Lr(p, u, n, r, o)
              : n && (o.lineStart(), r(null, null, 1, o), o.lineEnd()),
              o.polygonEnd(),
              (p = v = null);
          },
          sphere: function () {
  ...
  function Pr(n, t) {
    return (
      ((n = n.x)[0] < 0 ? n[1] - Ha - Fa : Ha - n[1]) -
      ((t = t.x)[0] < 0 ? t[1] - Ha - Fa : Ha - t[1])
    );
  }
  function Ur(n, t) {
    var r = n[0],
      ...
      if (s)
        for (
          ...
          var m = n[0],
            ...
            k = p * x;
          if (
            (kc.add(Math.atan2(k * b * Math.sin(w), v * M + k * Math.cos(w))),
            (i += S ? _ + b * ja : _),
            S ^ (h >= r) ^ (m >= r))
          ) {
            var E = dr(pr(f), pr(n));
  ...
  function Hr(n, t, r, e) {
    ...
    return Ma(o) > Fa
      ? Math.atan(
          (Math.sin(t) * (i = Math.cos(e)) * Math.sin(r) -
            Math.sin(e) * (u = Math.cos(t)) * Math.sin(n)) /
            (u * i * o)
        )
      : (t + e) / 2;
  }
        ...
        point: function (f, h) {
          ...
          if (
            ...
            v !== c &&
              ((g = e(r, p)),
              (br(r, g) || br(p, g)) &&
                ((p[0] += Fa), (p[1] += Fa), (v = t(p[0], p[1])))),
            v !== c)
          )
            (s = 0),
              v
                ? (n.lineStart(), (g = e(p, r)), n.point(g[0], g[1]))
                : ((g = e(r, p)), n.point(g[0], g[1]), n.lineEnd()),
              (r = g);
          else if (a && r && o ^ v) {
            var m;
            d & i ||
  ...
  function Zr(n, t, r, e) {
    ...
    return function (a) {
      ...
      function p(n, t) {
        (n = Math.max(-Fc, Math.min(Fc, n))),
          (t = Math.max(-Fc, Math.min(Fc, t)));
        var r = s(n, t);
        if ((d && m.push([n, t]), S))
          (y = n),
            (x = t),
            (M = r),
            (S = !1),
            r && (a.lineStart(), a.point(n, t));
        else if (r && w) a.point(n, t);
        else {
          var e = { a: { x: _, y: b }, b: { x: n, y: t } };
          A(e)
            ? (w || (a.lineStart(), a.point(e.a.x, e.a.y)),
              a.point(e.b.x, e.b.y),
              r || a.lineEnd(),
              (k = !1))
            : r && (a.lineStart(), a.point(n, t), (k = !1));
        }
        (_ = n), (b = t), (w = r);
      }
      var v,
        ...
        C = {
          ...
          polygonEnd: function () {
            ...
            (r || u) &&
              (a.polygonStart(),
              r && (a.lineStart(), l(null, null, 1, a), a.lineEnd()),
              u && Lr(v, i, t, l, a),
              a.polygonEnd()),
              (v = d = m = null);
          },
  ...
  function Vr(n, t) {
    (this.from = n),
      (this.to = t),
      (this.normal = dr(n, t)),
      (this.fromNormal = dr(this.normal, n)),
      (this.toNormal = dr(this.normal, t));
  }
  function $r(n, t) {
    ...
    var e = vr(r, n.fromNormal),
      ...
      i = vr(r, t.fromNormal),
      o = vr(r, t.toNormal);
    return e > -Oa && Oa > u && i > -Oa && Oa > o
      ? r
      : Oa > e && u > -Oa && Oa > i && o > -Oa
      ? ((r[0] = -r[0]), (r[1] = -r[1]), (r[2] = -r[2]), r)
      : void 0;
  }
  function Xr(n, t) {
    ...
    return (
      (n = vr(n, t.normal)),
      Math.abs(n) < Oa && ((r > -Oa && Oa > e) || (Oa > r && e > -Oa))
    );
  }
  function Br(n) {
    function t(t, r) {
          ...
          if (r) {
            for (
              ...
              if (x) {
                if (
                  ...
                  var M = 1e-4;
                  (l =
                    ((l + 3 * Ua + (Math.random() < 0.5 ? M : -M)) % (2 * Ua)) -
                    Ua),
                    (s = Math.min(
                      Ua / 2 - 1e-4,
                      Math.max(
                        1e-4 - Ua / 2,
                        s + (Math.random() < 0.5 ? M : -M)
                      )
                    )),
                    (p = new Vr(r, (h = pr([l, s])))),
                    (d = -1),
            ...
            if (v.length) {
              ...
              for (var d = 0; d < v.length; ++d) {
                var x = v[d];
                (g = !g)
                  ? (n.lineStart(), n.point(x[0], x[1], x.index, x.t))
                  : (n.point(x[0], x[1], x.index, x.t), n.lineEnd());
              }
            }
            g && n.point(l, s);
          } else {
            for (var d = 0, m = 100; d < u.length && m > 0; ++d) {
              ...
              if (Xr(h, y)) {
                ...
                (l =
                  ...
                  (s = Math.min(
                    Ua / 2 - 1e-4,
                    Math.max(1e-4 - Ua / 2, s + (Math.random() < 0.5 ? M : -M))
                  )),
                  (h = pr([l, s])),
                  (d = -1),
                  --m;
    ...
    function u(t, r, e, a, c, l, s, f, h, g, p, v, d, m) {
      ...
      if (M > 4 * i && d--) {
        var _ = a + g,
          ...
          T = x * L - y * q;
        ((T * T) / M > i ||
          Ma((y * L + x * q) / M - 0.5) > 0.3 ||
          o > a * g + c * p + l * v) &&
          (u(t, r, e, a, c, l, A, C, E, (_ /= S), (b /= S), w, d, m),
          m.point(A, C),
          u(A, C, E, _, b, w, s, f, h, g, p, v, d, m));
      }
    }
    var i = 0.5,
      o = Math.cos(30 * Ia),
  ...
  function pe(n) {
    ...
    return (
      ...
      (t.clipAngle = function (n) {
        return arguments.length
          ? ((M = null == n ? ((b = n), Hc) : Ir((b = +n) * Ia)), u())
          : b;
      }),
      (t.clipExtent = function (n) {
        return arguments.length
          ? ((S = n),
            (_ = n ? Zr(n[0][0], n[0][1], n[1][0], n[1][1]) : Nt),
            u())
          : S;
      }),
      (t.scale = function (n) {
      ...
      (t.clipPolygon = function (n) {
        return arguments.length
          ? ((b = null), (w = n), (M = null == n ? Hc : Br(n)), e())
          : w;
      }),
      function () {
  ...
  function be(n, t) {
    ...
    return function (u, i, o, a) {
      ...
      for (var l, s = u; o > 0 ? s > i : i > s; s -= c)
        a.point((l = _r([r, -e * Math.cos(s), -e * Math.sin(s)]))[0], l[1]);
    };
  }
  function we(n, t) {
    var r = pr(t);
    ...
    var u = Math.cos(t),
      ...
      p = h
        ? function (n) {
            ...
            return [
              Math.atan2(u, e) * Ya,
              Math.atan2(o, Math.sqrt(e * e + u * u)) * Ya,
            ];
          }
        : function () {
            return [n * Ya, t * Ya];
  ...
  function Ce() {
    function n(n, u) {
      var i = Math.sin((u *= Ia)),
        ...
        c = Math.cos(a);
      (Gc += Math.atan2(
        Math.sqrt((a = o * Math.sin(a)) * a + (a = e * i - r * o * c) * a),
        r * i + e * o * c
      )),
        (t = n),
        (r = i),
  ...
  function qe(n, t) {
    ...
    var e = Math.cos(n),
      ...
      i =
        n === t
          ? Math.sin(n)
          : Math.log(e / Math.cos(t)) / Math.log(u(t) / u(n)),
    ...
    return i
      ? ((r.invert = function (n, t) {
          ...
          return [
            Math.atan2(n, r) / i,
            2 * Math.atan(Math.pow(o / e, 1 / i)) - Ha,
          ];
        }),
        r)
      : ze;
  ...
  function $e(n) {
    ...
    for (
      var c = i;
      c.circle && Ma(r - c.circle.x) < Fa && Ma(e - c.circle.cy) < Fa;

    )
      (i = c.P), a.unshift(c), Ve(c), (c = i);
    a.unshift(c), tu(c);
    for (
      var l = o;
      l.circle && Ma(r - l.circle.x) < Fa && Ma(e - l.circle.cy) < Fa;

    )
      (o = l.N), a.push(l), Ve(l), (l = o);
    a.push(l), tu(l);
    var s,
      f = a.length;
    for (s = 1; f > s; ++s)
      (l = a[s]), (c = a[s - 1]), au(l.edge, c.site, l.site, u);
    (c = a[0]),
      (l = a[f - 1]),
      (l.edge = iu(c.site, l.site, null, u)),
      nu(c),
      nu(l);
  }
  function Xe(n) {
    ...
    if ((al.insert(t, c), t || r)) {
      if (t === r)
        return (
          ...
          (r = Ze(t.site)),
          al.insert(c, r),
          (c.edge = r.edge = iu(t.site, c.site)),
          nu(t),
          nu(r),
          void 0
        );
      ...
      var l = t.site,
        ...
        y = h * h + g * g,
        x = v * v + d * d,
        M = { x: (d * y - g * x) / m + s, y: (h * x - v * y) / m + f };
      au(r.edge, l, p, M),
        (c.edge = iu(l, n, null, M)),
        (r.edge = iu(n, p, null, M)),
        nu(t),
        nu(r);
    }
  }
  ...
  function tu(n) {
    var t = n.circle;
    t &&
      (t.P || (cl = t.N), ll.remove(t), fl.push(t), su(t), (n.circle = null));
  }
  function ru(n) {
    for (
      var t, r = il, e = Yr(n[0][0], n[0][1], n[1][0], n[1][1]), u = r.length;
      u--;
      ...
      (t = r[u]),
        (!eu(t, n) ||
          !e(t) ||
          (Ma(t.a.x - t.b.x) < Fa && Ma(t.a.y - t.b.y) < Fa)) &&
          ((t.a = t.b = null), r.splice(u, 1));
  }
  function eu(n, t) {
    var r = n.b;
    if (r) return !0;
  ...
  function iu(n, t, r, e) {
    ...
    return (
      ...
      r && au(u, n, t, r),
      e && au(u, t, n, e),
      ol[n.i].edges.push(new cu(u, n, t)),
      ol[t.i].edges.push(new cu(u, t, n)),
      u
    );
  }
  function ou(n, t, r) {
  ...
  function cu(n, t, r) {
    ...
    (this.edge = n),
      ...
      (this.angle = r
        ...
        : n.l === t
        ? Math.atan2(u.x - e.x, e.y - u.y)
        : Math.atan2(e.x - u.x, u.y - e.y));
  }
  function lu() {
    this._ = null;
  }
  ...
  function pu(n, t) {
    ...
    for (il = [], ol = new Array(n.length), al = new lu(), ll = new lu(); ; )
      if (((u = cl), i && (!u || i.y < u.y || (i.y === u.y && i.x < u.x))))
        (i.x !== r || i.y !== e) &&
          ((ol[i.i] = new We(i)), Xe(i), (r = i.x), (e = i.y)),
          (i = n.pop());
      else {
        if (!u) break;
        $e(u.arc);
  ...
  function Mu(n, t, r, e, u, i) {
    if (!n(t, r, e, u, i)) {
      var o = 0.5 * (r + u),
        a = 0.5 * (e + i),
        c = t.nodes;
      c[0] && Mu(n, c[0], r, e, o, a),
        c[1] && Mu(n, c[1], o, e, u, a),
        c[2] && Mu(n, c[2], r, a, o, i),
        c[3] && Mu(n, c[3], o, a, u, i);
    }
  }
  function _u(n, t) {
  ...
  function Su(n, t) {
    var r,
      ...
      l = [],
      s = [];
    for (n += '', t += '', gl.lastIndex = 0, e = 0; (r = gl.exec(t)); ++e)
      r.index && l.push(t.substring(a, (c = r.index))),
        s.push({ i: l.length, x: r[0] }),
        l.push(null),
        (a = gl.lastIndex);
    for (
      a < t.length && l.push(t.substring(a)), e = 0, i = s.length;
      (r = gl.exec(n)) && i > e;
      ++e
    )
      if (((o = s[e]), o.x == r[0])) {
        if (o.i)
          if (null == l[o.i + 1])
            for (l[o.i - 1] += o.x, l.splice(o.i, 1), u = e + 1; i > u; ++u)
              s[u].i--;
          else
            for (
              l[o.i - 1] += o.x + l[o.i + 1], l.splice(o.i, 2), u = e + 1;
              i > u;
              ++u
            )
              s[u].i -= 2;
          ...
          for (
            l[o.i] = o.x + l[o.i + 1], l.splice(o.i + 1, 1), u = e + 1;
            i > u;
            ++u
          )
            s[u].i--;
    ...
    for (; i > e; )
      (o = s.pop()),
        null == l[o.i + 1]
          ? (l[o.i] = o.x)
          : ((l[o.i] = o.x + l[o.i + 1]), l.splice(o.i + 1, 1)),
        i--;
    return 1 === l.length
      ? null == l[0]
        ? ((o = s[0].x),
  ...
  function ku(n, t) {
    for (
      var r, e = oa.interpolators.length;
      --e >= 0 && !(r = oa.interpolators[e](n, t));
  ...
  function Zu(n) {
    ...
    t[0] * r[1] < r[0] * t[1] &&
      ((t[0] *= -1), (t[1] *= -1), (e *= -1), (u *= -1)),
      (this.rotate =
        (e ? Math.atan2(t[1], t[0]) : Math.atan2(-r[0], r[1])) * Ya),
    ...
    return (
      a[0] != c[0] || a[1] != c[1]
        ? (e.push('translate(', null, ',', null, ')'),
          u.push({ i: 1, x: wu(a[0], c[0]) }, { i: 3, x: wu(a[1], c[1]) }))
        : c[0] || c[1]
        ? e.push('translate(' + c + ')')
        : e.push(''),
      l != s
        ...
        : s && e.push(e.pop() + 'rotate(' + s + ')'),
      f != h
        ? u.push({ i: e.push(e.pop() + 'skewX(', null, ')') - 2, x: wu(f, h) })
        : h && e.push(e.pop() + 'skewX(' + h + ')'),
      g[0] != p[0] || g[1] != p[1]
        ? ((r = e.push(e.pop() + 'scale(', null, ',', null, ')')),
          u.push(
            { i: r - 4, x: wu(g[0], p[0]) },
            { i: r - 2, x: wu(g[1], p[1]) }
          ))
        : (1 != p[0] || 1 != p[1]) && e.push(e.pop() + 'scale(' + p + ')'),
      (r = u.length),
      function (n) {
  ...
  function Gu(n) {
    for (var t = n.source, r = n.target, e = Qu(t, r), u = [t]; t !== e; )
      (t = t.parent), u.push(t);
  ...
  function Qu(n, t) {
    if (n === t) return n;
    for (
      var r = Ku(n), e = Ku(t), u = r.pop(), i = e.pop(), o = null;
      u === i;
  ...
  function Pi(n) {
    ...
    if ((r = n.children) && (l = r.length)) {
      ...
      if (
        ...
        (e.y = 0),
        t(e),
        l > 1 && ((u = r[1]), (u.x = u.r), (u.y = 0), t(u), l > 2))
      )
        for (
          i = r[2],
            Fi(e, u, i),
          ...
          if (1 == p)
            for (
              c = e._pack_prev;
              c !== a._pack_prev && !Di(c, i);
              c = c._pack_prev, d++
            );
          p
            ? (d > v || (v == d && u.r < e.r) ? Ri(e, (u = a)) : Ri((e = c), u),
              o--)
            : (zi(e, i), (u = i), t(i));
        }
      var m = (s + f) / 2,
  ...
  function Fi(n, t, r) {
    ...
    if (e && (u || i)) {
      ...
      var c = 0.5 + (e - o) / (2 * a),
        l =
          Math.sqrt(Math.max(0, 2 * o * (e + a) - (e -= a) * e - o * o)) /
          (2 * a);
  ...
  function ro(n, t) {
    ...
    return (
      ...
      (r[0] = Math.ceil(r[0] / u) * u),
      (r[1] = Math.floor(r[1] / u) * u + 0.5 * u),
      (r[2] = u),
      r
    );
  }
  ...
  function oo(n, t) {
    var r = io(t[2]);
    return n in kl
      ? Math.abs(r - io(Math.max(Ma(t[0]), Ma(t[1])))) + +('e' !== n)
      : r - 2 * ('%' === n);
  }
  function ao(n, t, r, e) {
    function u(n) {
      return (
        (r ? Math.log(0 > n ? 0 : n) : -Math.log(n > 0 ? 0 : -n)) / Math.log(t)
      );
    }
    function i(n) {
    ...
    return (
      ...
      (o.domain = function (t) {
        return arguments.length
          ? ((r = t[0] >= 0), n.domain((e = t.map(Number)).map(u)), o)
          : e;
      }),
      (o.base = function (r) {
      ...
      (o.tickFormat = function (n, t) {
        ...
        arguments.length < 2
          ? (t = El)
          : 'function' != typeof t && (t = oa.format(t));
        var e,
  ...
  function co(n, t, r) {
    ...
    return (
      ...
      (e.exponent = function (o) {
        return arguments.length
          ? ((u = lo((t = o))), (i = lo(1 / t)), n.domain(r.map(u)), e)
          : t;
      }),
      (e.copy = function () {
  ...
  function so(n, t) {
    function r(r) {
      return i[
        ((u.get(r) || ('range' === t.t ? u.set(r, n.push(r)) : 0 / 0)) - 1) %
          i.length
      ];
    }
    function e(t, r) {
    ...
    return (
      ...
      (r.range = function (n) {
        return arguments.length
          ? ((i = n), (a = 0), (t = { t: 'range', a: arguments }), r)
          : i;
      }),
      (r.rangePoints = function (u, o) {
        ...
        return (
          (i = e(n.length < 2 ? (c + l) / 2 : c + (s * o) / 2, s)),
          (a = 0),
  ...
  function ho(n, t, r) {
    ...
    return (
      ...
      (e.invertExtent = function (t) {
        return (
          (t = r.indexOf(t)), (t = 0 > t ? 0 / 0 : t / i + n), [t, t + 1 / i]
        );
      }),
      (e.copy = function () {
        return ho(n, t, r);
  ...
  function Mo(n) {
    function t(t) {
      ...
      for (
        var c, l = [], s = [], f = -1, h = t.length, g = Et(r), p = Et(e);
        ++f < h;
    ...
    return (
      ...
      (t.interpolate = function (n) {
        return arguments.length
          ? ((o = 'function' == typeof n ? (i = n) : (i = Rl.get(n) || _o).key),
            t)
          : o;
      }),
  ...
  function wo(n) {
    for (var t = 0, r = n.length, e = n[0], u = [e[0], ',', e[1]]; ++t < r; )
  ...
  function No(n, t) {
    return n.length < 3
      ? _o(n)
      : n[0] +
          Co((n.push(n[0]), n), Lo([n[n.length - 2]].concat(n, [n[1]]), t));
  }
  function Ao(n, t) {
  ...
  function Lo(n, t) {
    for (
      var r, e = [], u = (1 - t) / 2, i = n[0], o = n[1], a = 1, c = n.length;
      ++a < c;
  ...
  function qo(n) {
    ...
    for (n.push(n[r - 1]); ++t <= r; )
      (e = n[t]), o.shift(), o.push(e[0]), a.shift(), a.push(e[1]), Po(c, o, a);
  ...
  function To(n) {
    ...
    for (r.push(Do(Ul, i) + ',' + Do(Ul, o)), --e; ++e < u; )
      (t = n[e]), i.shift(), i.push(t[0]), o.shift(), o.push(t[1]), Po(r, i, o);
    return r.join('');
  }
  function zo(n) {
    for (var t, r, e = -1, u = n.length, i = u + 4, o = [], a = []; ++e < 4; )
      (r = n[e % u]), o.push(r[0]), a.push(r[1]);
    for (t = [Do(Ul, o), ',', Do(Ul, a)], --e; ++e < i; )
      (r = n[e % u]),
        o.shift(),
        o.push(r[0]),
        a.shift(),
  ...
  function jo(n) {
    for (
      ...
      e[t] = (o + (o = Uo((u = i), (i = n[t + 1])))) / 2;
    return (e[t] = o), e;
  }
  function Ho(n) {
    for (var t, r, e, u, i = [], o = jo(n), a = -1, c = n.length - 1; ++a < c; )
      (t = Uo(n[a], n[a + 1])),
        Ma(t) < Fa
          ? (o[a] = o[a + 1] = 0)
          : ((r = o[a] / t),
  ...
  function Io(n) {
    ...
    return (
      ...
      (t.interpolate = function (n) {
        return arguments.length
          ? ((c = 'function' == typeof n ? (a = n) : (a = Rl.get(n) || _o).key),
            (l = a.reverse || a),
            (s = a.closed ? 'M' : 'L'),
            t)
          : c;
          ...
          function (e) {
            ...
            function c(e) {
              ...
              for (var o = e / g, a = f(o), c = v.length; c > 0; )
                v[--c].call(n, a);
              return o >= 1
                ? (i.event && i.event.end.call(n, s, t), l())
                : void 0;
            }
            function l() {
  ...
  (oa.ascending = n),
    ...
    (oa.median = function (r, e) {
      return (
        arguments.length > 1 && (r = r.map(e)),
        (r = r.filter(t)),
        r.length ? oa.quantile(r.sort(n), 0.5) : void 0
      );
    });
  var xa = r(n);
  (oa.bisectLeft = xa.left),
    (oa.bisect = oa.bisectRight = xa.right),
    (oa.bisector = function (t) {
      return r(
        1 === t.length
          ? function (r, e) {
              return n(t(r), e);
    ...
    (oa.pairs = function (n) {
      for (
        var t, r = 0, e = n.length - 1, u = n[0], i = new Array(0 > e ? 0 : e);
        e > r;
    ...
    (oa.entries = function (n) {
      var t = [];
      for (var r in n) t.push({ key: r, value: n[r] });
      return t;
    }),
    (oa.merge = function (n) {
  ...
  (oa.range = function (n, t, r) {
    ...
    var e,
      ...
      a = -1;
    if (((n *= o), (t *= o), (r *= o), 0 > r))
      for (; (e = n + r * ++a) > t; ) i.push(e / o);
    else for (; (e = n + r * ++a) < t; ) i.push(e / o);
    return i;
  }),
    (oa.map = function (n) {
      var t = new o();
    ...
    i(o, {
      ...
      forEach: function (n) {
        for (var t in this)
          t.charCodeAt(0) === ba && n.call(this, t.substring(1), this[t]);
      },
    });
  var _a = '\x00',
    ba = _a.charCodeAt(0);
  (oa.nest = function () {
    function n(t, a, c) {
      ...
      for (
        var l, s, f, h, g = -1, p = a.length, v = i[c++], d = new o();
        ++g < p;
    ...
    i(h, {
      ...
      forEach: function (n) {
        for (var t in this)
          t.charCodeAt(0) === ba && n.call(this, t.substring(1));
      },
    }),
    (oa.behavior = {}),
  ...
  (La.select = function (n) {
    ...
    for (var o = -1, a = this.length; ++o < a; ) {
      ...
      for (var c = -1, l = e.length; ++c < l; )
        (u = e[c])
          ? (t.push((r = n.call(u, u.__data__, c, o))),
            r && '__data__' in u && (r.__data__ = u.__data__))
          : t.push(null);
    }
    return _(i);
  }),
    (La.selectAll = function (n) {
      ...
      for (var u = -1, i = this.length; ++u < i; )
        for (var o = this[u], a = -1, c = o.length; ++a < c; )
          (r = o[a]) &&
            (e.push((t = ca(n.call(r, r.__data__, a, u)))), (t.parentNode = r));
      return _(e);
    });
  var qa = {
  ...
  (oa.ns = {
    ...
    qualify: function (n) {
      var t = n.indexOf(':'),
        r = n;
      return (
        t >= 0 && ((r = n.substring(0, t)), (n = n.substring(t + 1))),
        qa.hasOwnProperty(r) ? { space: qa[r], local: n } : n
      );
    },
  }),
    (La.attr = function (n, t) {
      if (arguments.length < 2) {
        if ('string' == typeof n) {
          ...
          return (
            (n = oa.ns.qualify(n)),
            n.local ? r.getAttributeNS(n.space, n.local) : r.getAttribute(n)
          );
        }
    ...
    (La.style = function (n, t, r) {
      ...
      if (3 > e) {
        ...
        if (2 > e)
          return fa.getComputedStyle(this.node(), null).getPropertyValue(n);
        r = '';
      }
      ...
      function r(n, r) {
        ...
        if (t) {
          var d,
            ...
            x = [];
          for (e = -1; ++e < a; )
            (d = t.call((u = n[e]), u.__data__, e)),
              m.has(d) ? (v[e] = u) : m.set(d, u),
              x.push(d);
          for (e = -1; ++e < f; )
            (d = t.call(r, (i = r[e]), e)),
              (u = m.get(d))
  ...
  var Ta = [];
  (oa.selection.enter = U),
    (oa.selection.enter.prototype = Ta),
    (Ta.append = La.append),
    (Ta.empty = La.empty),
    (Ta.node = La.node),
    (Ta.call = La.call),
    ...
    (Ta.select = function (n) {
      for (var t, r, e, u, i, o = [], a = -1, c = this.length; ++a < c; ) {
        ...
        for (var l = -1, s = u.length; ++l < s; )
          (i = u[l])
            ? (t.push((e[l] = r = n.call(u.parentNode, i.__data__, l, a))),
              (r.__data__ = i.__data__))
            : t.push(null);
      }
      return _(o);
    }),
    ...
    (La.transition = function () {
      for (
        var n,
          ...
          r = Hl || ++Zl,
          e = [],
          u = Fl || { time: Date.now(), ease: Tu, delay: 0, duration: 250 },
          i = -1,
          o = this.length;
        ++i < o;
  ...
  var Ra = oa.map({ mouseenter: 'mouseover', mouseleave: 'mouseout' });
      ...
      function t(n, t, u, i, o) {
        return function () {
          ...
          var l,
            ...
            x = t(h, v);
          e
            ? ((l = e.apply(s, arguments)), (l = [l.x - x[0], l.y - x[1]]))
            : (l = [0, 0]),
            g({ type: 'dragstart' });
        };
      }
  ...
  (oa.interpolateZoom = function (n, t) {
    ...
    (oa.behavior.zoom = function () {
      ...
      function l() {
        ...
        function r() {
          f.on(A, fa === e ? h : null).on(C, null),
            p(s && oa.event.target === i),
            c(l);
        }
        var e = this,
          i = oa.event.target,
      ...
      function s() {
        ...
        function r() {
          for (var t = oa.event.changedTouches, r = 0, i = t.length; i > r; ++r)
            v[t[r].identifier] = null;
          var o = n(),
            c = Date.now();
          if (1 === o.length) {
            if (500 > c - m) {
        ...
        function i() {
          for (
            var n, t, r, i, o = oa.touches(g), c = 0, l = o.length;
            l > c;
            ++c, i = null
          )
        ...
        function f() {
          if (oa.event.touches.length) {
            for (
              var t = oa.event.changedTouches, r = 0, e = t.length;
              e > r;
              ++r
            )
      ...
      function f() {
        ...
        p || (p = t(r)), e(Math.pow(2, 0.002 * Xa()) * S.k), u(r, p), a(n);
      }
      function h() {
        p = null;
      }
      function g() {
        ...
        o(n),
          e(
            Math.pow(
              2,
              oa.event.shiftKey ? Math.ceil(l) - 1 : Math.floor(l) + 1
            )
          ),
          u(r, i),
          a(n),
              ...
              ? oa
                  ...
                  .tween('zoom:zoom', function () {
                    var r = k[0],
                      ...
                      u = r / 2,
                      i = e / 2,
                      o = oa.interpolateZoom(
                        [(u - S.x) / S.k, (i - S.y) / S.k, r / S.k],
                        [(u - t.x) / t.k, (i - t.y) / t.k, r / t.k]
                      );
                    return function (t) {
                      var e = o(t),
                        c = r / e[2];
                      (this.__chart__ = S =
                        { x: u - e[0] * c, y: i - e[1] * c, k: c }),
                        a(n);
                    };
                  })
  ...
  (Wa.brighter = function (n) {
    return (
      ...
      et(this.h, this.s, this.l / n)
    );
  }),
    (Wa.darker = function (n) {
      return (
        (n = Math.pow(0.7, arguments.length ? n : 1)),
        et(this.h, this.s, n * this.l)
      );
    }),
    (Wa.rgb = function () {
    ...
    (oa.hcl = function (n, t, r) {
      return 1 === arguments.length
        ? n instanceof at
          ...
          : n instanceof st
          ? ht(n.l, n.a, n.b)
          : ht((n = wt((n = oa.rgb(n)).r, n.g, n.b)).l, n.a, n.b)
        : ot(+n, +t, +r);
    });
  ...
  (Ga.brighter = function (n) {
    return ot(
      this.h,
      this.c,
      Math.min(100, this.l + Ka * (arguments.length ? n : 1))
    );
  }),
    (Ga.darker = function (n) {
      return ot(
        this.h,
        this.c,
        Math.max(0, this.l - Ka * (arguments.length ? n : 1))
      );
    }),
    (Ga.rgb = function () {
        ...
        (r.parseRows = function (n, t) {
          function r() {
            ...
            if (34 === n.charCodeAt(t)) {
              ...
              return (
                13 === e
                  ? ((u = !0), 10 === n.charCodeAt(r + 2) && ++s)
                  : 10 === e && (u = !0),
                n.substring(t + 1, r).replace(/""/g, '"')
              );
            }
            for (; l > s; ) {
          ...
          for (
            var e, u, i = {}, o = {}, a = [], l = n.length, s = 0, f = 0;
            (e = r()) !== o;
  ...
  (oa.timer = function (n, t, r) {
    ...
    oc ? (oc.n = i) : (ic = i),
      (oc = i),
      ac || ((cc = clearTimeout(cc)), (ac = 1), sc(qt));
  }),
  ...
  oa.formatPrefix = function (n, t) {
    ...
    return (
      n &&
        (0 > n && (n *= -1),
        t && (n = oa.round(n, Rt(n, t))),
        (r = 1 + Math.floor(1e-12 + Math.log(n) / Math.LN10)),
        (r = Math.max(-24, Math.min(24, 3 * Math.floor((r - 1) / 3))))),
      fc[8 + r / 3]
    );
  };
  var hc =
    ...
    gc = oa.map({
      ...
      r: function (n, t) {
        return (n = oa.round(n, Rt(n, t))).toFixed(
  ...
  (pc.year = Ht(
    ...
    (pc.years = pc.year.range),
    (pc.years.utc = pc.year.utc.range),
    (pc.day = Ht(
      function (n) {
        var t = new vc(2e3, 0);
    ...
    (pc.days = pc.day.range),
    (pc.days.utc = pc.day.utc.range),
    (pc.dayOfYear = function (n) {
      var t = pc.year(n);
      return Math.floor(
    ...
    [
      ...
      var r = (pc[n] = Ht(
        function (n) {
          return (
            (n = pc.day(n)).setDate(n.getDate() - ((n.getDay() + t) % 7)), n
          );
        },
        function (n, t) {
      ...
      (pc[n + 's'] = r.range),
        (pc[n + 's'].utc = r.utc.range),
        (pc[n + 'OfYear'] = function (n) {
          var r = pc.year(n).getDay();
          return Math.floor((pc.dayOfYear(n) + ((r + t) % 7)) / 7);
        });
    }),
    (pc.week = pc.sunday),
    (pc.weeks = pc.sunday.range),
    (pc.weeks.utc = pc.sunday.utc.range),
    (pc.weekOfYear = pc.sundayOfYear);
  var mc = { '-': '', _: ' ', 0: '0' },
    yc = /^\s*\d+/,
    xc = /^%/;
  ...
  (oa.format = Mc.numberFormat),
    ...
    (cr.prototype = {
      ...
      add: function (n) {
        lr(n, this.t, _c),
          lr(_c.s, this.s, this),
          this.s ? (this.t += _c.t) : (this.s = _c.t);
      },
      reset: function () {
        this.s = this.t = 0;
      },
  ...
  var Sc,
    ...
    Ec = {
      ...
      polygonEnd: function () {
        var n = 2 * kc;
        (Sc += 0 > n ? 4 * Ua + n : n),
          (Ec.lineStart = Ec.lineEnd = Ec.point = v);
      },
    };
  (oa.geo.bounds = (function () {
    ...
    return function (n) {
      ...
      if (t) {
        ...
        for (var r, e = 1, u = x[0], i = [u]; t > e; ++e)
          (r = x[e]),
            l(r[0], u) || l(r[1], u)
              ? (a(u[0], r[1]) > a(u[0], u[1]) && (u[1] = r[1]),
                a(r[0], u[1]) > a(u[0], u[1]) && (u[0] = r[0]))
              : i.push((u = r));
        for (
          var o, r, p = -1 / 0, t = i.length - 1, e = 0, u = i[t];
          t >= e;
          u = r, ++e
        )
          (r = i[e]),
            (o = a(u[1], r[0])) > p && ((p = o), (s = r[0]), (h = u[1]));
      }
      return (
        (x = M = null),
        1 / 0 === s || 1 / 0 === f
    ...
    (oa.geo.centroid = function (n) {
      (Nc = Ac = Cc = Lc = qc = Tc = zc = Rc = Dc = Pc = Uc = 0),
        oa.geo.stream(n, jc);
      var t = Dc,
        r = Pc,
        e = Uc,
      ...
      return Oa > u &&
        ...
        (r = zc),
        (e = Rc),
        Fa > Ac && ((t = Cc), (r = Lc), (e = qc)),
        (u = t * t + r * r + e * e),
        Oa > u)
        ? [0 / 0, 0 / 0]
        : [Math.atan2(r, t) * Ya, G(e / Math.sqrt(u)) * Ya];
    });
  var Nc,
    Ac,
    Cc,
  ...
  (oa.geo.clipExtent = function () {
    ...
    (oa.geo.distance = function (n, t) {
      var r,
        ...
        f = Math.cos(i);
      return Math.atan2(
        Math.sqrt((r = f * o) * r + (r = l * s - c * f * a) * r),
        c * s + l * f * a
      );
    });
  var Oc = {};
      ...
      return (
        (n.invert = function (n) {
          var t = i.scale(),
            ...
            u = (n[1] - r[1]) / t;
          return (
            u >= 0.12 && 0.234 > u && e >= -0.425 && -0.214 > e
              ? o
              : u >= 0.166 && 0.234 > u && e >= -0.214 && -0.115 > e
              ? a
              : i
          ).invert(n);
        }),
        ...
        (n.translate = function (t) {
          ...
          return (
            ...
            (e = o
              ...
              .clipExtent([
                [s - 0.425 * l + Fa, f + 0.12 * l + Fa],
                [s - 0.214 * l - Fa, f + 0.234 * l - Fa],
              ])
              .stream(c).point),
            (u = a
              .translate([s - 0.205 * l, f + 0.212 * l])
              .clipExtent([
                [s - 0.214 * l + Fa, f + 0.166 * l + Fa],
                [s - 0.115 * l - Fa, f + 0.234 * l - Fa],
              ])
              .stream(c).point),
            n
          );
  ...
  (oa.geo.path = function () {
    ...
    return (
      ...
      (n.centroid = function (n) {
        return (
          (Cc = Lc = qc = Tc = zc = Rc = Dc = Pc = Uc = 0),
          oa.geo.stream(n, u(Wc)),
          Uc
            ? [Dc / Uc, Pc / Uc]
            : Rc
            ? [Tc / Rc, zc / Rc]
      ...
      (n.projection = function (n) {
        return arguments.length
          ? ((u = (r = n) ? n.stream || se(n) : Nt), t())
          : r;
      }),
      (n.context = function (n) {
        return arguments.length
          ? ((i = null == (e = n) ? new re() : new ce(n)),
    ...
    (oa.geo.projection = ge),
    (oa.geo.projectionMutator = pe),
    ...
    (oa.geo.rotation = function (n) {
      ...
      return (
        (n = ye((n[0] % 360) * Ia, n[1] * Ia, n.length > 2 ? n[2] * Ia : 0)),
        (t.invert = function (t) {
          return (
            (t = n.invert(t[0] * Ia, t[1] * Ia)), (t[0] *= Ya), (t[1] *= Ya), t
          );
        }),
        t
      );
    ...
    (oa.geo.graticule = function () {
      ...
      function t() {
        return oa
          ...
          .map(h)
          .concat(oa.range(Math.ceil(l / m) * m, c, m).map(g))
          .concat(
            oa
              .range(Math.ceil(e / p) * p, r, p)
              .filter(function (n) {
                return Ma(n % d) > Fa;
              })
              .map(s)
    ...
    (oa.geo.greatArc = function () {
      ...
      return (
        ...
        (n.source = function (r) {
          return arguments.length
            ? ((e = r), (t = 'function' == typeof r ? null : r), n)
            : e;
        }),
        (n.target = function (t) {
          return arguments.length
            ? ((u = t), (r = 'function' == typeof t ? null : t), n)
            : u;
        }),
    ...
    (ul.clip = function (n) {
      for (
        ...
        for (
          ...
          (o = t[r]),
            Fe(o, s, u)
              ? (Fe(i, s, u) || n.push(Oe(i, o, s, u)), n.push(o))
              : Fe(i, s, u) && n.push(Oe(i, o, s, u)),
            (i = o);
        a && n.push(n[0]), (s = u);
      }
      return n;
        ...
        if (
          ...
          do {
            ...
            if (n === u.L) {
              if (
                ((t = u.R),
                t.C && ((t.C = !1), (u.C = !0), fu(this, u), (t = u.R)),
                (t.L && t.L.C) || (t.R && t.R.C))
              ) {
                (t.R && t.R.C) ||
                  ((t.L.C = !1), (t.C = !0), hu(this, t), (t = u.R)),
                  (t.C = u.C),
                  (u.C = t.R.C = !1),
                  fu(this, u),
                  (n = this._);
              ...
              ((t = u.L),
              t.C && ((t.C = !1), (u.C = !0), hu(this, u), (t = u.L)),
              (t.L && t.L.C) || (t.R && t.R.C))
            ) {
              (t.L && t.L.C) ||
                ((t.R.C = !1), (t.C = !0), fu(this, t), (t = u.L)),
                (t.C = u.C),
                (u.C = t.L.C = !1),
                hu(this, u),
                (n = this._);
    ...
    (oa.geom.voronoi = function (n) {
      function t(n) {
        var t = new Array(n.length),
          ...
          o = a[1][1];
        return (
          pu(r(n), a).cells.forEach(function (r, a) {
            var c = r.edges,
              l = r.site,
              s = (t[a] = c.length
                ? c.map(function (n) {
      ...
      return n
        ...
        : ((t.links = function (n) {
          ...
          (t.triangles = function (n) {
            var t = [];
            return (
              pu(r(n)).cells.forEach(function (r, e) {
                for (
                  var u,
                    i,
                    o = r.site,
  ...
  (oa.geom.delaunay = function (n) {
    ...
    (oa.geom.quadtree = function (n, t, r, e, u) {
          ...
          if (!isNaN(r) && !isNaN(e))
            if (n.leaf) {
              var c = n.x,
                s = n.y;
              if (null != c)
                if (Ma(c - r) + Ma(s - e) < 0.01) l(n, t, r, e, u, i, o, a);
                else {
                  var f = n.point;
      ...
      return (o = arguments.length)
        ? ((a = mu), (c = yu), 3 === o && ((u = r), (e = t), (r = t = 0)), i(n))
        : ((i.x = function (n) {
    ...
    (oa.interpolateRgb = _u),
    (oa.interpolateObject = bu),
    (oa.interpolateNumber = wu),
    (oa.interpolateString = Su);
  var gl = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g;
  (oa.interpolate = ku),
    (oa.interpolators = [
      function (n, t) {
  ...
  (oa.ease = function (n) {
    ...
    return (
      (r = vl.get(r) || pl),
      (e = dl.get(e) || Nt),
      Nu(e(r.apply(null, aa.call(arguments, 1))))
    );
  }),
    (oa.interpolateHcl = Fu),
    (oa.interpolateHsl = Ou),
    (oa.interpolateLab = Iu),
    (oa.interpolateRound = Yu),
  ...
  (oa.interpolateTransform = Bu),
    ...
    (oa.layout.chord = function () {
      function n() {
        ...
        for (
          ...
          (e[y] = { index: y, startAngle: f, endAngle: l, value: (l - f) / n }),
            (l += s);
        }
        for (h = -1; ++h < i; )
          for (g = h - 1; ++g < i; ) {
    ...
    (oa.layout.force = function () {
      ...
      return (
        (a.tick = function () {
          if ((e *= 0.99) < 0.005)
            return c.end({ type: 'end', alpha: (e = 0) }), !0;
          var t,
            r,
            a,
            f,
          ...
          if (g)
            for (ui((t = oa.geom.quadtree(m)), e, o), r = -1; ++r < _; )
        ...
        (a.start = function () {
          function n(n, e) {
            if (!r) {
              ...
              for (a = 0; l > a; ++a) {
                var u = y[a];
                r[u.source.index].push(u.target),
                  r[u.target.index].push(u.source);
              }
            }
          ...
          for (t = 0; s > t; ++t)
            (e = y[t]),
              'number' == typeof e.source && (e.source = m[e.source]),
              'number' == typeof e.target && (e.target = m[e.target]),
              ++e.source.weight,
              ++e.target.weight;
          for (t = 0; c > t; ++t)
            (e = m[t]),
          ...
          return (
            r ||
              (r = oa.behavior
                .drag()
                .origin(Nt)
                .on('dragstart.force', ni)
                .on('drag.force', t)
                .on('dragend.force', ti)),
            arguments.length
              ? (this.on('mouseover.force', ri)
  ...
  (oa.layout.hierarchy = function () {
    function n(t, o, a) {
      ...
      if (((t.depth = o), a.push(t), c && (l = c.length))) {
        for (
          var l, s, f = -1, h = (t.children = new Array(l)), g = 0, p = o + 1;
          ++f < l;

        )
          (s = h[f] = n(c[f], p, a)), (s.parent = t), (g += s.value);
      ...
      function n(t, r, e, u) {
        ...
        if (
          ...
          var o,
            ...
            c,
            l = -1;
          for (e = t.value ? e / t.value : 0; ++l < o; )
            n((a = i[l]), r, (c = a.value * e), u), (r += c);
        }
      }
      function t(n) {
        var r = n.children,
  ...
  oa.layout.stack = function () {
    ...
    return (
      ...
      (n.order = function (t) {
        return arguments.length
          ? ((r = 'function' == typeof t ? t : bl.get(t) || gi), n)
          : r;
      }),
      (n.offset = function (t) {
        return arguments.length
          ? ((e = 'function' == typeof t ? t : wl.get(t) || pi), n)
          : e;
      }),
      (n.x = function (t) {
  ...
  var bl = oa.map({
      'inside-out': function (n) {
        ...
        for (t = 0; e > t; ++t)
          (r = o[t]),
            c > a ? ((a += i[r]), l.push(r)) : ((c += i[r]), s.push(r));
  ...
  (oa.layout.histogram = function () {
      ...
      if (g > 0)
        for (i = -1; ++i < h; )
          (a = l[i]),
            a >= s[0] &&
              a <= s[1] &&
              ((o = c[oa.bisect(f, a, 1, g) - 1]), (o.y += p), o.push(n[i]));
      return c;
    }
    var t = !0,
      r = Number,
      ...
      function n(n, i) {
        function o(n, t) {
          var e = n.children,
            u = n._tree;
          if (e && (i = e.length)) {
            for (var i, a, l, s = e[0], f = s, h = -1; ++h < i; )
              (l = e[h]), o(l, a), (f = c(l, a, f)), (a = l);
            Ci(n);
            var g = 0.5 * (s._tree.prelim + l._tree.prelim);
            t
              ? ((u.prelim = t._tree.prelim + r(n, t)), (u.mod = u.prelim - g))
              : (u.prelim = g);
          ...
          if (t) {
            for (
              ...
              (c = bi(c)),
                (o = wi(o)),
                (o._tree.ancestor = n),
                (u = a._tree.prelim + f - i._tree.prelim - l + r(a, i)),
                u > 0 && (Li(qi(a, n, e), n, u), (l += u), (s += u)),
                (f += a._tree.mod),
                (l += i._tree.mod),
                (h += c._tree.mod),
                (s += o._tree.mod);
            a && !wi(o) && ((o._tree.thread = a), (o._tree.mod += f - s)),
              i &&
                !bi(c) &&
                ((c._tree.thread = i), (c._tree.mod += l - h), (e = n));
          }
          return e;
        }
    ...
    (oa.layout.pack = function () {
      ...
      return (
        ...
        (n.radius = function (r) {
          return arguments.length
            ? ((t = null == r || 'function' == typeof r ? r : +r), n)
            : t;
        }),
    ...
    (oa.layout.treemap = function () {
      function n(n, t) {
        for (var r, e, u = -1, i = n.length; ++u < i; )
          (e = (r = n[u]).value * (0 > t ? 0 : t)),
            (r.area = isNaN(e) || 0 >= e ? 0 : e);
      }
      function t(r) {
        var i = r.children;
        if (i && i.length) {
            ...
            v =
              'slice' === g
                ...
                ? 1 & r.depth
                  ...
                  : l.dx
                : Math.min(l.dx, l.dy);
          for (n(h, (l.dx * l.dy) / r.value), s.area = 0; (c = h.length) > 0; )
            s.push((o = h[c - 1])),
              (s.area += o.area),
              'squarify' !== g || (a = e(s, v)) <= p
                ? (h.pop(), (p = a))
                : ((s.area -= s.pop().area),
                  u(s, v, l, !1),
      ...
      function e(n, t) {
        for (
          var r, e = n.area, u = 0, i = 1 / 0, o = -1, a = n.length;
          ++o < a;
        ...
        return (
          (e *= e),
          (t *= t),
          e ? Math.max((t * u * p) / e, e / (t * i * p)) : 1 / 0
        );
      }
      function u(n, t, r, e) {
        var u,
          ...
          s = t ? c(n.area / t) : 0;
        if (t == r.dx) {
          for ((e || s > r.dy) && (s = r.dy); ++i < o; )
            (u = n[i]),
              (u.x = a),
              (u.y = l),
              (u.dy = s),
              (a += u.dx = Math.min(r.x + r.dx - a, s ? c(u.area / s) : 0));
          (u.z = !0), (u.dx += r.x + r.dx - a), (r.y += s), (r.dy -= s);
        } else {
          for ((e || s > r.dx) && (s = r.dx); ++i < o; )
            (u = n[i]),
              (u.x = a),
              (u.y = l),
              (u.dx = s),
              (l += u.dy = Math.min(r.y + r.dy - l, s ? c(u.area / s) : 0));
    ...
    (oa.svg.chord = function () {
      function n(n, a) {
        ...
        return (
          'M' +
          c.p0 +
          e(c.r, c.p1, c.a1 - c.a0) +
          (r(c, l)
            ? u(c.r, c.p1, c.r, c.p0)
            : u(c.r, c.p1, l.r, l.p0) +
              e(l.r, l.p1, l.a1 - l.a0) +
              u(l.r, l.p1, c.r, c.p0)) +
          'Z'
        );
      }
  ...
  (Yl.call = La.call),
    ...
    (Yl.select = function (n) {
      ...
      for (var o = -1, a = this.length; ++o < a; ) {
        ...
        for (var c = this[o], l = -1, s = c.length; ++l < s; )
          (e = c[l]) && (r = n.call(e, e.__data__, l, o))
            ? ('__data__' in e && (r.__data__ = e.__data__),
              Ko(r, l, u, e.__transition__[u]),
              t.push(r))
            : t.push(null);
      }
      return Jo(i, u);
    ...
    (Yl.selectAll = function (n) {
      ...
      for (var c = -1, l = this.length; ++c < l; )
        for (var s = this[c], f = -1, h = s.length; ++f < h; )
          if ((e = s[f])) {
            (i = e.__transition__[o]),
              (r = n.call(e, e.__data__, f, c)),
              a.push((t = []));
            for (var g = -1, p = r.length; ++g < p; )
              (u = r[g]) && Ko(u, g, o, i), t.push(u);
          }
      return Jo(a, o);
    }),
    ...
    (Yl.tween = function (n, t) {
      var r = this.id;
      return arguments.length < 2
        ? this.node().__transition__[r].tween.get(n)
        : P(
            this,
            null == t
              ? function (t) {
      ...
      function i(n) {
        return null == n
          ...
          : ((n += ''),
            function () {
              var t,
                r = this.getAttributeNS(a.space, a.local);
              return (
                r !== n &&
                ((t = o(r, n)),
                function (n) {
    ...
    (Yl.styleTween = function (n, t, r) {
      function e(e, u) {
        var i = t.call(
          ...
          e,
          u,
          fa.getComputedStyle(this, null).getPropertyValue(n)
        );
        return (
          i &&
          function (t) {
    ...
    (Yl.duration = function (n) {
      ...
      return arguments.length < 1
        ...
        : P(
            ...
            'function' == typeof n
              ? function (r, e, u) {
                  r.__transition__[t].duration = Math.max(
                    1,
                    n.call(r, r.__data__, e, u)
                  );
                }
              : ((n = Math.max(1, n)),
                function (r) {
    ...
    (Yl.transition = function () {
      for (
        var n, t, r, e, u = this.id, i = ++Zl, o = [], a = 0, c = this.length;
        c > a;
        a++
      ) {
        o.push((n = []));
        for (var t = this[a], l = 0, s = t.length; s > l; l++)
          (r = t[l]) &&
            ((e = Object.create(r.__transition__[u])),
            (e.delay += e.duration),
            Ko(r, l, i, e)),
            n.push(r);
      }
  ...
  oa.svg.brush = function () {
    function n(i) {
      i.each(function () {
        ...
        var s,
          f = oa.transition(i),
          h = oa.transition(o);
        c && ((s = Bi(c)), h.attr('x', s[0]).attr('width', s[1] - s[0]), r(f)),
          l &&
            ((s = Bi(l)), h.attr('y', s[0]).attr('height', s[1] - s[0]), e(f)),
          t(f);
      });
    }
    function t(n) {
    ...
    function u() {
      function u() {
        32 == oa.event.keyCode &&
          (A || ((x = null), (L[0] -= s[1]), (L[1] -= f[1]), (A = 2)), y());
      }
      function p() {
        32 == oa.event.keyCode &&
          2 == A &&
          ((L[0] += s[1]), (L[1] += f[1]), (A = 0), y());
      }
      function v() {
        var n = oa.mouse(_),
          u = !1;
      ...
      function d(n, t, r) {
        ...
        return (
          A && ((c -= p), (l -= d + p)),
          (e = (r ? g : h) ? Math.max(c, Math.min(l, n[r])) : n[r]),
          A
            ? (u = (e += p) + d)
            : (x && (p = Math.max(c, Math.min(l, 2 * x[r] - e))),
              e > p ? ((u = e), (e = p)) : (u = p)),
          v[0] != e || v[1] != u
            ? (r ? (o = null) : (i = null), (v[0] = e), (v[1] = u), !0)
            : void 0
        );
      }
      function m() {
      ...
      S.style('pointer-events', 'none')
        .selectAll('.resize')
        .style('display', null),
        oa.select('body').style('cursor', b.style('cursor')),
        w({ type: 'brushstart' }),
        v();
    }
    var i,
        ...
        return arguments.length
          ...
          : (c &&
              (i
                ...
                : ((r = s[0]),
                  (e = s[1]),
                  c.invert && ((r = c.invert(r)), (e = c.invert(e))),
                  r > e && ((h = r), (r = e), (e = h)))),
            l &&
              (o
                ? ((u = o[0]), (a = o[1]))
                : ((u = f[0]),
                  (a = f[1]),
                  l.invert && ((u = l.invert(u)), (a = l.invert(a))),
                  u > a && ((h = u), (u = a), (a = h)))),
            c && l
              ? [
                  [r, u],
  ...
  (Jl.iso =
    ...
    (pc.seconds = pc.second.range),
    (pc.seconds.utc = pc.second.utc.range),
    (pc.minute = Ht(
      function (n) {
    ...
    (pc.minutes = pc.minute.range),
    (pc.minutes.utc = pc.minute.utc.range),
    (pc.hour = Ht(
      function (n) {
    ...
    (pc.hours = pc.hour.range),
    (pc.hours.utc = pc.hour.utc.range),
    (pc.month = Ht(
      function (n) {
    ...
    (pc.months = pc.month.range),
    (pc.months.utc = pc.month.utc.range);
  var Kl = [
